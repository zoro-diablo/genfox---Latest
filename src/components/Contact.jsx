...
export default function ContactUs({ nameInputRef }) {
  ...
  return (
    <motion.div
      ...
      className='max-w-5xl my-[100px] w-full mx-auto flex flex-col md:flex-row items-center rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-white'
    >
      {/* Form Section */}
      <motion.div
      ...
      >
        <form className='my-8' onSubmit={handleSubmit}>
          <h2 className='font-bold text-3xl text-neutral-800 '>Contact Us</h2>
          <p className='text-neutral-500 text-sm max-w-sm mt-2 mb-12 font-medium '>
